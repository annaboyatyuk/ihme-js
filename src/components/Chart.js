...
import { BarChart, Bar, XAxis, YAxis, CartesianGrid, Tooltip, Legend, ReferenceLine, Brush, Label } from 'recharts';
    ...
    if (this.props.allData.compareYears) {
      ...
      return (
        <Fragment>
          ...
          <BarChart className='chart' width={1040} height={440} data={this.props.csvData}
            ...
            <Brush dataKey='year' height={30} stroke='#00dc6d' startIndex={0}
          endIndex={15}/>
      ...
      return (
        <Fragment>
          ...
          <BarChart className='chart' width={1040} height={440} data={this.props.csvData}
            ...
            {/* <Legend /> */}
            <ReferenceLine y={0} stroke='#000' />
            <Brush dataKey='location_name' height={30} stroke='#00dc6d' className='zoomBrush' startIndex={0}
          endIndex={15}/>
            <Bar dataKey='val' fill='#004d26' />
